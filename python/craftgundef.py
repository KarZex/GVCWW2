...
for row in csv_reader:
    ...
    if( row_count >= 1 ):
        ...
        if gun_onehand:
            with open("behavior_packs/GVCWW2Bedrock/functions/hold/{}iih.mcfunction".format(gun_id),"w",encoding="utf-8") as f:
                if gun_special == "R":
        ...
        with open("tool/item.json","r") as f:
            ...
            gun_item["minecraft:item"]["components"]["minecraft:allow_off_hand"] = gun_onehand
        
        with open("behavior_packs/GVCWW2Bedrock/items/gun/{}.json".format(gun_id),"w") as f:
        ...
        with open("behavior_packs/GVCWW2Bedrock/recipes/gun/{}.json".format(gun_id),"w") as f:
        ...
        with open("behavior_packs/GVCWW2Bedrock/loot_tables/gun/{}.json".format(gun_id),"w") as f:
        ...
        with open("resource_packs/GVCWW2Bedrock/entity/gun/ak12.json","r") as f:
            gun_entity = json.load(f)
        ...
        with open("resource_packs/GVCWW2Bedrock/entity/gun/s/{}.json".format(gun_id),"w") as f:
            gun_entity["minecraft:client_entity"]["description"]["identifier"] = "fire:ads_{}".format(gun_id)
            json.dump(gun_entity,f,indent=2)

        with open("resource_packs/GVCWW2Bedrock/render_controllers/first_person.json","r") as f:
            gun_entity = json.load(f)
        ...
        with open("resource_packs/GVCWW2Bedrock/render_controllers/first_person.json","w") as f:
            json.dump(gun_entity,f,indent=2)
    ...
    if( row_count >= 1 ):
        ...
        if( "H" not in gun_offset ):
            ...
            if( gun_offset == "D" ):
                ...
                with open("resource_packs/GVCWW2Bedrock/entity/gun/{}r.json".format(gun_id),"w") as f:
                    json.dump(gun_entity,f,indent=2)
...
with open("behavior_packs/GVCWW2Bedrock/animation_controllers/hold.json","w") as f:
...
with open("behavior_packs/GVCWW2Bedrock/scripts/gun.json","r") as f:

...
def get_ammo(ammo_str):
    csv_path_w = open("csv/vehiclewData.csv","r")
...
terrain_texture = json.load(open("resource_packs/GVCWW2Bedrock/textures/terrain_texture.json","r"))
...
for row in csv_reader:
    ...
    if( row_count >= 1 ):
        ...
        vehicledata_json["{}".format(v_id)] = { "type": v_type,"speed": v_speed,"Weapon1": v_weapon1,"Weapon2": v_weapon2,"Weapon3": v_weapon3,"Weapon4": v_weapon4,"turn": v_turn,"gattack":v_gattack,"FuelPerSecond":v_fuelPerSec }
        ...
        v_weapon1_item = get_ammo(v_weapon1)
        v_weapon2_item = get_ammo(v_weapon2)
        v_weapon3_item = get_ammo(v_weapon3)
        v_weapon4_item = get_ammo(v_weapon4)
        ...
        with open("behavior_packs/GVCWW2Bedrock/blocks/spawns/spawn_vehicle_{}.json".format(v_id.replace(":","_")),"w") as s:
            json.dump(block_json,s,indent=2)

        overlay_image = Image.open("resource_packs/GVCWW2Bedrock/textures/items/vehicle/{}.png".format(v_id)).convert("RGBA")
        base_image = Image.open("resource_packs/GVCWW2Bedrock/textures/spawn/base.png").convert("RGBA")
        combined = Image.alpha_composite(base_image, overlay_image)
        combined.save("resource_packs/GVCWW2Bedrock/textures/spawn/vehicle_{}.png".format(v_id) )
        ...
        with open("behavior_packs/GVCWW2Bedrock/entities/vehicle/{0}/{1}.json".format(v_type,v_id),"w") as f:
        ...
        with open("behavior_packs/GVCWW2Bedrock/loot_tables/entities/{}.json".format(v_id),"w") as f:
            json.dump(loot_table,f,indent=2)
                      
        if v_weapon1 != "":
            v_weapon1_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run event entity @s[scores={{weaponi=..{2}}},hasitem={{item={3}}}] fire:{1}\n".format(v_id,v_weapon1,v_weapon1_ammo,v_weapon1_item)
            v_weapon1_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run clear @s[scores={{weaponi=..{2}}},hasitem={{item={3}}}] {3} 0 1\n".format(v_id,v_weapon1,v_weapon1_ammo,v_weapon1_item)
            v_weapon1_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run scoreboard players add @s[scores={{weaponi=..{2}}},hasitem={{item={3}}}] weaponi 1\n".format(v_id,v_weapon1,v_weapon1_ammo,v_weapon1_item)
        ...
        if v_weapon2 != "":
            v_weapon2_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run event entity @s[scores={{weaponii=..{2}}},hasitem={{item={3}}}] fire:{1}\n".format(v_id,v_weapon2,v_weapon2_ammo,v_weapon2_item)
            v_weapon2_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run clear @s[scores={{weaponii=..{2}}},hasitem={{item={3}}}] {3} 0 1\n".format(v_id,v_weapon2,v_weapon2_ammo,v_weapon2_item)
            v_weapon2_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run scoreboard players add @s[scores={{weaponii=..{2}}},hasitem={{item={3}}}] weaponii 1\n".format(v_id,v_weapon2,v_weapon2_ammo,v_weapon2_item)
        ...
        if v_weapon3 != "":
            v_weapon3_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run event entity @s[scores={{weaponiii=..{2}}},hasitem={{item={3}}}] fire:{1}\n".format(v_id,v_weapon3,v_weapon3_ammo,v_weapon3_item)
            v_weapon3_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run clear @s[scores={{weaponiii=..{2}}},hasitem={{item={3}}}] {3} 0 1\n".format(v_id,v_weapon3,v_weapon3_ammo,v_weapon3_item)
            v_weapon3_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run scoreboard players add @s[scores={{weaponiii=..{2}}},hasitem={{item={3}}}] weaponiii 1\n".format(v_id,v_weapon3,v_weapon3_ammo,v_weapon3_item)
        ...
        if v_weapon4 != "":
            v_weapon4_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run event entity @s[scores={{weaponiv=..{2}}},hasitem={{item={3}}}] fire:{1}\n".format(v_id,v_weapon4,v_weapon4_ammo,v_weapon4_item)
            v_weapon4_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run clear @s[scores={{weaponiv=..{2}}},hasitem={{item={3}}}] {3} 0 1\n".format(v_id,v_weapon4,v_weapon4_ammo,v_weapon4_item)
            v_weapon4_func += "\nexecute if entity @e[r=7,type=vehicle:{0}] run scoreboard players add @s[scores={{weaponiv=..{2}}},hasitem={{item={3}}}] weaponiv 1\n".format(v_id,v_weapon4,v_weapon4_ammo,v_weapon4_item)
...
with open("behavior_packs/GVCWW2Bedrock/functions/weaponi.mcfunction","w") as f:
    f.write(v_weapon1_func)
with open("behavior_packs/GVCWW2Bedrock/functions/weaponii.mcfunction","w") as f:
    f.write(v_weapon2_func)
with open("behavior_packs/GVCWW2Bedrock/functions/weaponiii.mcfunction","w") as f:
    f.write(v_weapon3_func)
with open("behavior_packs/GVCWW2Bedrock/functions/weaponiv.mcfunction","w") as f:
...
with open("resource_packs/GVCWW2Bedrock/textures/terrain_texture.json","w") as f:
    json.dump(terrain_texture,f,indent=2)

with open("behavior_packs/GVCWW2Bedrock/functions/b1.mcfunction","w") as f:
    f.write(b_func)

with open("resource_packs/GVCWW2Bedrock/texts/vehicle_name.lang","w") as f:
    f.write(names)
...
with open("resource_packs/GVCWW2Bedrock/texts/vech.txt","w") as f:
    f.write(text)

with open("resource_packs/GVCWW2Bedrock/texts/evech.txt","w") as f:
    f.write(eng_text)
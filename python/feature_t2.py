    ...
    if( row_count >= 1 and row[4] != "" ):
        ...
        if structure_flag_type != "":
            ...
            with open("tool/a1red.json","r") as f:
                ...
                flag_json["minecraft:entity"]["components"]["minecraft:type_family"]["family"] = [ "redflag","flag","redteam","allied_soldier","inanimate" ]
            ...
            with open("behavior_packs/GVCWW2Bedrock/entities/flag/team/flag_red_{}.json".format(structure_id),"w") as f:
            ...
            with open("tool/a1blue.json","r") as f:
                ...
                flag_json["minecraft:entity"]["components"]["minecraft:type_family"]["family"] = [ "blueflag","flag","blueteam","allied_soldier","inanimate" ]
                if structure_flag_type == "L":
                    flag_json["minecraft:entity"]["components"]["minecraft:health"]["value"] = 400
                    flag_json["minecraft:entity"]["components"]["minecraft:health"]["max"] = 400

            with open("behavior_packs/GVCWW2Bedrock/entities/flag/team/flag_blue_{}.json".format(structure_id),"w") as f:
                json.dump(flag_json,f,indent=2)
            ...
            with open("tool/a1green.json","r") as f:
                ...
                flag_json["minecraft:entity"]["components"]["minecraft:type_family"]["family"] = [ "greenflag","flag","greenteam","allied_soldier","inanimate" ]
                if structure_flag_type == "L":
                    flag_json["minecraft:entity"]["components"]["minecraft:health"]["value"] = 400
                    flag_json["minecraft:entity"]["components"]["minecraft:health"]["max"] = 400

            with open("behavior_packs/GVCWW2Bedrock/entities/flag/team/flag_green_{}.json".format(structure_id),"w") as f:
                json.dump(flag_json,f,indent=2)
            ...
            with open("tool/a1yellow.json","r") as f:
                ...
                flag_json["minecraft:entity"]["components"]["minecraft:type_family"]["family"] = [ "yellowflag","flag","yellowteam","allied_soldier","inanimate" ]
                if structure_flag_type == "L":
                    flag_json["minecraft:entity"]["components"]["minecraft:health"]["value"] = 400
                    flag_json["minecraft:entity"]["components"]["minecraft:health"]["max"] = 400

            with open("behavior_packs/GVCWW2Bedrock/entities/flag/team/flag_yellow_{}.json".format(structure_id),"w") as f:
                json.dump(flag_json,f,indent=2)
            ...
            with open("resource_packs/GVCWW2Bedrock/entity/flag/{}_ca.json".format(structure_id),"w") as f:
            ...
            with open("resource_packs/GVCWW2Bedrock/entity/flag/{}_ga.json".format(structure_id),"w") as f:
                json.dump(flag_r_json,f,indent=2)
            ...
            with open("resource_packs/GVCWW2Bedrock/entity/flag/{}_red.json".format(structure_id),"w") as f:
                ...
                json.dump(flag_r_json,f,indent=2)
            with open("resource_packs/GVCWW2Bedrock/entity/flag/{}_blue.json".format(structure_id),"w") as f:
                ...
                json.dump(flag_r_json,f,indent=2)
            with open("resource_packs/GVCWW2Bedrock/entity/flag/{}_green.json".format(structure_id),"w") as f:
                ...
                json.dump(flag_r_json,f,indent=2)
            with open("resource_packs/GVCWW2Bedrock/entity/flag/{}_yellow.json".format(structure_id),"w") as f:

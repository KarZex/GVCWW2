execute positioned ~-42~~-42 run scoreboard players set @a[dx=84,dz=84,family=!JAPteam,tag=!working] antiMining 200
...
execute positioned ~-42~-320~-42 as @a[dx=84,dy=640,dz=84,tag=JAPSub,tag=working] run scriptevent zex:jailwork JAP

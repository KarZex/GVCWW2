...
execute as @s[tag=!ride] if entity @e[r=4,type=vehicle:yak9] run event entity @s 23mmmcair

execute as @s[tag=!ride] if entity @e[r=4,type=vehicle:il2] run event entity @s bomb

execute as @s[tag=!ride] if entity @e[r=4,type=vehicle:zero] run event entity @s 23mmmcair

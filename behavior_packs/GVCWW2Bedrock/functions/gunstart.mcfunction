...
execute as @s[tag=!startedww2] run scoreboard players set @s mcoolii 0
execute as @s[tag=!startedww2] run scoreboard players set @s scool 0
execute as @s[tag=!startedww2] run scoreboard players set @s subWeapon 30
execute as @s[tag=!startedww2] run scoreboard players set @s maxsubcool 0
...
execute as @a[tag=!startedww2] run scoreboard players set @s tt33 9

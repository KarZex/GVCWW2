...
execute if entity @e[r=4,type=vehicle:t34] if entity @s[scores={mcool=0}] run scoreboard players set @s[scores={mtype=0..}] mcool 70

execute if entity @e[r=4,type=vehicle:panzer] if entity @s[scores={mcool=0}] run event entity @s[scores={mtype=0..}] fire:76mm
execute if entity @e[r=4,type=vehicle:panzer] if entity @s[scores={mcool=0}] run scoreboard players set @s[scores={mtype=0..}] mcool 45

execute if entity @e[r=4,type=vehicle:m4] if entity @s[scores={mcool=0}] run event entity @s[scores={mtype=0..}] fire:76mm
execute if entity @e[r=4,type=vehicle:m4] if entity @s[scores={mcool=0}] run scoreboard players set @s[scores={mtype=0..}] mcool 50

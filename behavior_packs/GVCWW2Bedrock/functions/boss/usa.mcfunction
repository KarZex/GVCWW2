...
effect @e[family=USAteam,r=60] regeneration 1 2 false
effect @e[family=USAteam,r=60] resistance 1 4 false
...
scoreboard players set @a[r=60,family=!USAteam,tag=!working] antiMining 200


## warning
title @a[r=60,family=!USAteam,tag=!working] title "This is American Base"
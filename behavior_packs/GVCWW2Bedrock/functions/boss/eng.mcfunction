...
effect @e[family=ENGteam,r=60] regeneration 1 2 false
effect @e[family=ENGteam,r=60] resistance 1 4 false
...
scoreboard players set @a[r=60,family=!ENGteam,tag=!working] antiMining 200


## warning
title @a[r=60,family=!ENGteam,tag=!working] title "This is British Base"